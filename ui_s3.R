...
filenames <- sapply(strsplit(system("aws configure set aws_access_key_id AKIAJBOMPSJ7FPIHIXZA;
       aws configure set aws_secret_access_key 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; aws s3 ls shiny-nightlights/data/", intern=TRUE), "[ ]+"), function(x) x[4])
